...
const ElectricBill = () => {
  ...
  const AddTransaction = async (props: newTransaction) => {
    ...
    try {
      ...
      transactionSetter(newTransactions);
      const db = await getDBConnection();
      await setAccountInfo(db, newTransactions);
    } catch (err) {
      console.error(err);
    }
  };
  ...
  const createTwoButtonAlert = () =>
    Alert.alert(
      'Money Transfer',
      `Are sure you want to spend ${amount} birr for Electric Bill`,
      [
        {
          text: 'Cancel',
      ...
      <View style={styles.contain}>
        <View>
          ...
          <TextInput
            ...
            value={amount}
            placeholder="enter your amount for Electric bill"
